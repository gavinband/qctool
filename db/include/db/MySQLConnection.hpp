...
namespace db {
	...
	public:
		...
		MySQLConnection( std::string const& db_spec, bool overwrite = true ) ;
	...
	public:
		MYSQL_STMT* prepare_sql( std::string const& SQL ) const ;
		void finalise_statement( MYSQL_STMT* statement ) ;
		void step_statement( MYSQL_STMT* statement ) ;
