...
def build( bld ):
	...
	create_app( bld, name='qctool', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib qcdb appcontext statfile appcontext string_utils fputils worker genfile metro' )
	...
	create_app( bld, name='inthinnerator', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib genfile statfile qcdb appcontext db' )
	create_app( bld, name='gen-grep', uselib = USELIB, uselib_local = 'gen-tools-lib genfile appcontext string_utils' )
	create_app( bld, name='bingwa', uselib = 'BOOST_REGEX ' + USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib SNPSummaryComponent qcdb appcontext db sqlite3 statfile genfile' )
