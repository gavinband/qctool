...
def build( bld ):
	...
	# programs
	#---------------------
	USELIB = "BOOST BOOST_IOSTREAMS ZLIB BOOST_FILESYSTEM BOOST_SYSTEM BOOST_UNIT_TEST_FRAMEWORK BOOST_THREAD PTHREAD CBLAS CLAPACK MGL"
	Components = 'SNPSummaryComponent SampleSummaryComponent CallComparerComponent HaplotypeFrequencyComponent RelatednessComponent SNPOutputComponent'
	create_app( bld, name='qctool', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile appcontext string_utils fputils worker genfile ' )
	...
	create_app( bld, name='inthinnerator', uselib = USELIB, uselib_local = 'SNPSummaryComponent qctool_version_autogenerated gen-tools-lib gen-tools-exception genfile statfile appcontext' )
	...
	create_app( bld, name='bingwa', uselib = USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile genfile SNPSummaryComponent qcdb db' )
