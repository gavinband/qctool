...
def build( bld ):
	...
	# programs
	#---------------------
	create_app( bld, name='qctool', uselib = 'BOOST_THREAD', uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile appcontext string_utils fputils worker CallComparerComponent HaplotypeFrequencyComponent SNPSummaryComponent SampleSummaryComponent RelatednessComponent genfile' )
	create_app( bld, name='overrep', uselib = 'BOOST_REGEX', uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile genfile' )
