...
def check_for_3rd_party_components( conf ):
	...
	if conf.check_cxx( lib = 'gsl', uselib_store = 'GSL', cxxflags = '-I/opt/local/include', linkflags = '-L/opt/local/lib' ):
		conf.define( 'HAVE_GSL', 1 )
...
def build( bld ):
	...
	bld.new_task_gen(
		...
		uselib = 'BOOST BOOST_IOSTREAMS ZLIB BOOST_MATH BOOST_FILESYSTEM BOOST_SYSTEM BOOST_TIMER BOOST_CHRONO CBLAS CLAPACK'
	)

	#---------------------
	# programs
	#---------------------
	USELIB = "BOOST BOOST_IOSTREAMS ZLIB BOOST_FILESYSTEM BOOST_SYSTEM BOOST_UNIT_TEST_FRAMEWORK BOOST_THREAD BOOST_TIMER BOOST_CHRONO PTHREAD CBLAS CLAPACK"
	...
	create_app( bld, name='qctool', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile appcontext string_utils fputils worker genfile metro' )
	create_app( bld, name='overrep', uselib = 'BOOST_REGEX ' + USELIB, uselib_local = 'qctool_version_autogenerated appcontext gen-tools-lib gen-tools-exception genfile statfile' )
	create_app( bld, name='inthinnerator', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib gen-tools-exception genfile statfile appcontext qcdb db' )
	create_app( bld, name='gen-grep', uselib = USELIB, uselib_local = 'gen-tools-exception gen-tools-lib genfile appcontext string_utils' )
	create_app( bld, name='bingwa', uselib = USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext genfile SNPSummaryComponent qcdb statfile db sqlite3' )
	create_app( bld, name='inflation', uselib = USELIB, uselib_local = 'qctool_version_autogenerated appcontext genfile ' )

	#---------------------
	# benchmarks
	#---------------------
	create_benchmark( bld, 'benchmark-statistics', uselib = USELIB )
...
def create_tests( bld, uselib = '', components = '' ):
	bld.new_task_gen(
		...
		uselib_local = 'gen-tools-lib gen-tools-exception genfile appcontext string_utils ' + components,
		includes='./include ./genfile/include',
