...
def build( bld ):
	...
	create_app( bld, name='cat-bgen', uselib = USELIB, uselib_local = 'qctool_version_autogenerated appcontext genfile' )
	create_app( bld, name='edit-bgen', uselib = USELIB, uselib_local = 'qctool_version_autogenerated appcontext genfile' )
