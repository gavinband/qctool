...
def build( bld ):
	...
	create_app( bld, name='amet', uselib = 'BOOST_REGEX', uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile genfile SNPSummaryComponent' )
