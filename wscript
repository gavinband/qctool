...
def build( bld ):
	...
	create_app( bld, name='correlator', uselib = USELIB, uselib_local = Components + ' gen-tools-lib qcdb appcontext statfile appcontext string_utils fputils worker genfile metro qctool_version_autogenerated' )
	...
	create_app( bld, name='inthinnerator', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib qcdb genfile statfile appcontext' )
