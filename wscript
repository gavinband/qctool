...
def check_for_3rd_party_components( conf ):
	...
	if conf.check_cxx( lib = 'mgl', uselib_store = 'MGL', cxxflags = '-I /opt/local/include -I' + conf.env['PREFIX'] + '/include', linkflags ='-L' + conf.env['PREFIX'] + '/lib' ):
...
def build( bld ):
	...
	Components = 'SNPSummaryComponent SampleSummaryComponent HaplotypeFrequencyComponent RelatednessComponent SNPOutputComponent boost'
	create_app( bld, name='qctool', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib appcontext statfile appcontext string_utils fputils worker genfile metro' )
	create_app( bld, name='overrep', uselib = 'BOOST_REGEX ' + USELIB, uselib_local = 'qctool_version_autogenerated appcontext gen-tools-lib genfile statfile' )
	create_app( bld, name='inthinnerator', uselib = USELIB, uselib_local = Components + ' qctool_version_autogenerated gen-tools-lib genfile statfile appcontext qcdb db' )
	create_app( bld, name='gen-grep', uselib = USELIB, uselib_local = 'gen-tools-lib genfile appcontext string_utils' )
	create_app( bld, name='bingwa', uselib = 'BOOST_REGEX ' + USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib appcontext SNPSummaryComponent qcdb db sqlite3 statfile genfile' )
