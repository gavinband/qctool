...
def build( bld ):
	...
	create_app( bld, name='ldbird', uselib = USELIB, uselib_local = Components + ' gen-tools-lib qcdb appcontext statfile appcontext string_utils fputils worker genfile metro qctool_version_autogenerated' )
