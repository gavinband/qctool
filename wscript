...
def build( bld ):
	...
	# programs
	#---------------------
	BOOST_DEPENDENCIES = "BOOST BOOST_IOSTREAMS ZLIB BOOST_FILESYSTEM BOOST_SYSTEM BOOST_UNIT_TEST_FRAMEWORK"
	create_app( bld, name='qctool', uselib = BOOST_DEPENDENCIES, uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext statfile appcontext string_utils fputils worker CallComparerComponent HaplotypeFrequencyComponent SNPSummaryComponent RelatednessComponent genfile' )
