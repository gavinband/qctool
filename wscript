...
def build( bld ):
	...
	# programs
	#---------------------
	create_app( bld, name='qctool', uselib = 'BOOST_THREAD', uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception appcontext genfile statfile appcontext string_utils fputils worker CallComparerComponent HaplotypeFrequencyComponent SNPSummaryComponent RelatednessComponent' )
