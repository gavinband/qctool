...
def build( bld ):
	...
	create_app( bld, name='inthinnerator', uselib = USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib gen-tools-exception genfile statfile appcontext' )
