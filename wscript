...
def build( bld ):
	...
	# programs
	#---------------------
	USELIB = "BOOST BOOST_IOSTREAMS ZLIB BOOST_FILESYSTEM BOOST_SYSTEM BOOST_UNIT_TEST_FRAMEWORK BOOST_THREAD BOOST_TIMER BOOST_CHRONO PTHREAD CBLAS CLAPACK MGL"
