...
def build( bld ):
	...
	create_app( bld, name='bingwa', uselib = 'BOOST_REGEX ' + USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib appcontext genfile SNPSummaryComponent qcdb statfile db sqlite3' )
