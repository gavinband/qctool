...
g++ -O3 -o qctool-static src/*.cpp string_utils/src/*.cpp genfile/src/*.cpp statfile/src/*.cpp $BOOST_PREFIX/lib/libboost_iostreams-gcc43-mt-1_44.a $BOOST_PREFIX/lib/libboost_filesystem-gcc43-mt-1_44.a /usr/lib/libz.a -static-libgcc -static -I include/ -I string_utils/include/ -I genfile/include/ -I statfile/include/ -I $BOOST_PREFIX/include/boost-1_44/ /usr/lib/libz.a -I build/release/statfile/ -DHAVE_ZLIB=1 -DHAVE_BOOST=1 -DHAVE_BOOST_FILESYSTEM=1 -I build/release/genfile/include/ apps/qctool.cpp $BOOST_PREFIX/lib/libboost_system-gcc43-mt-1_44.a
