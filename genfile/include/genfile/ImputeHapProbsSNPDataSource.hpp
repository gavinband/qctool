...
#ifndef GENFILEIMPUTEHAPPROBSSNPDATASOURCE_HPP
#define GENFILEIMPUTEHAPPROBSSNPDATASOURCE_HPP
...
namespace genfile {
	namespace impl {
		struct ImputeHapProbsSNPDataReader ;
	}
	// This class represents a SNPDataSource which reads its data
	// from a plain GEN file.
	class ImputeHapProbsSNPDataSource: public IdentifyingDataCachingSNPDataSource
	{
		friend struct impl::ImputeHapProbsSNPDataReader ;
	public:
		ImputeHapProbsSNPDataSource( std::auto_ptr< std::istream > stream, Chromosome chromosome ) ;
		ImputeHapProbsSNPDataSource( std::string const& filename, Chromosome chromosome ) ;
