...
namespace genfile {
	...
	uint8_t const* read_little_endian_integer( uint8_t const* buffer, uint8_t const* const end, IntegerType* integer_ptr ) {
	...
	void read_little_endian_integer( std::istream& in_stream, IntegerType* integer_ptr ) {
		uint8_t buffer[ sizeof( IntegerType ) ] ;
	...
	template< typename IntegerType >
	uint8_t const* read_big_endian_integer( uint8_t const* buffer, uint8_t const* const end, IntegerType* integer_ptr ) {
		assert( end >= buffer + sizeof( IntegerType )) ;
		*integer_ptr = 0 ;
		for( std::size_t byte_i = 0; byte_i < sizeof( IntegerType ); ++byte_i ) {
	...
	template< typename IntegerType >
	uint8_t* write_little_endian_integer( uint8_t* buffer, uint8_t* const end, IntegerType const integer ) {
		assert( end >= buffer + sizeof( IntegerType )) ;
		for( std::size_t byte_i = 0; byte_i < sizeof( IntegerType ); ++byte_i ) {
	...
	template< typename IntegerType >
	uint8_t* write_big_endian_integer( uint8_t* buffer, uint8_t* const end, IntegerType const integer ) {
		assert( end >= buffer + sizeof( IntegerType )) ;
		for( std::size_t byte_i = 0; byte_i < sizeof( IntegerType ); ++byte_i ) {
	...
	namespace impl {
		...
		struct small_integer_writer< IntegerType, true >
		{
			...
			uint8_t const* read( uint8_t const* buffer, uint8_t const* const end, IntegerType* integer ) const {
				assert( end >= buffer + 1 ) ;
				uint8_t num_bytes = *buffer++ ;
	...
	template< typename IntegerType >
	uint8_t* write_small_integer( uint8_t* buffer, uint8_t* const end, IntegerType const integer ) {
	...
	template< typename IntegerType >
	uint8_t const* read_small_integer( uint8_t const* buffer, uint8_t const* const end, IntegerType* integer ) {
