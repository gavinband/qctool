...
namespace genfile {
	...
	// Write an integer of a given type to the buffer.
	// The integer is stored as a single character giving the number of bytes,
	// followed by little-endian storage of that many bytes.
	// The fewest bytes possible are chosen.
	template< typename IntegerType >
