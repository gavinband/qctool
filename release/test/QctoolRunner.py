...
class QctoolRunner:
	...
	def run_qctool( self, command, expected, qctool = None ):
		...
		for option in [ 'vcf-genotype-field', 'incl-positions', 'excl-positions', 'incl-snpids', 'excl-snpids', 'incl-rsids', 'excl-rsids', 'incl-samples', 'excl-samples', 'osnp', 'osample', 'ofiletype', 'filetype', 'annotate-bed3', 'annotate-bed4', 'merge-in', 'assume-chromosome', 'threshold', 'reorder', 'infer-ploidy-from' ]:
