...
#ifndef SQLITEINTENSITIESSNPDATASINK_HPP
#define SQLITEINTENSITIESSNPDATASINK_HPP
...
#include "qcdb/DBOutputter.hpp"
	...
	// to a plain GEN file.
	class SQLiteIntensitiesSNPDataSink: public genfile::SNPDataSink
	{
	public:
		SQLiteIntensitiesSNPDataSink( qcdb::DBOutputter::UniquePtr outputter ) ;
