...
namespace sample_stats {
	DBOutputter::UniquePtr DBOutputter::create( std::string const& filename, std::string const& cohort_name, Metadata const& metadata, genfile::CohortIndividualSource const& samples ) {
		return UniquePtr( new DBOutputter( filename, cohort_name, metadata, samples ) ) ;
	}
	DBOutputter::SharedPtr DBOutputter::create_shared( std::string const& filename, std::string const& cohort_name, Metadata const& metadata, genfile::CohortIndividualSource const& samples ) {
		return SharedPtr( new DBOutputter( filename, cohort_name, metadata, samples ) ) ;
	}

	DBOutputter::DBOutputter( std::string const& filename, std::string const& cohort_name, Metadata const& metadata, genfile::CohortIndividualSource const& samples ):
